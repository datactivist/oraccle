...
author: "Samuel Goëta, Joël Gombin,<br />Antoine Blanchard -- Datactivist"
...
.footnote[[Rosenberg (2013), "Data before the fact", dans Lisa Gitelman (dir.) (2013), *"Raw Data" is an oxymoron*, MIT Press](https://mitpress.mit.edu/books/raw-data-oxymoron)]
...
.footnote[[Lisa Gitelman (dir.) (2013), *"Raw Data" is an<br />oxymoron*, MIT Press](https://mitpress.mit.edu/books/raw-data-oxymoron)]
...
* les classes peuvent être codées par une valeur numérique arbitraire, qui ne signifie rien (ex. : 1 pour homme et 2 pour femme)
...
Observation, enquête, expérimentation, prise de notes, capteurs… dont l'intention première est de générer des données.
...
.right-column[
- .red[**Gouverner la population**] (*governing people*) : dans la continuité de la tradition statistique de l'État, améliorer le service rendu au public, prévenir les crimes et délits…
...
- s'appuie sur des formats ouverts : RDF / SPARQL
- Wikidata comme données pivot

.center.reduite3[
![](./img/lod-datasets_2009-07-14_cropped.png)
]
