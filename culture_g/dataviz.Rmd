...
Dans le cas d'une carte, le choix de l'échelle peut mener à la généralisation de phénomène extrêmement circonscrits (ou inversement) comme le montre cet [exemple sur le blog de Datawrapper](https://blog.datawrapper.de/weekly-chart-europegrowth/)
...
.center.reduite2[
[![](./img/NebuleusePublicPrive.png)](https://pegasusdata.com/2012/11/25/opendata-copinage-au-gouvernement-quand-lanalyse-de-reseau-vient-en-aide-au-journalisme-dinvestigation/)
]
...
.pull-left[
- Allez sur www.datawrapper.de et cliquez sur "**Start creating**"
...
- Nommer la nouvelle colonne "Parti" et remplissez les cellules de la nouvelle colonne avec le nom des partis politiques
